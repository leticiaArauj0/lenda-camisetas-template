...
export function EditEmailForm({ currentEmail }: EditEmailFormProps) {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Endereço de Email</CardTitle>
                <CardDescription>
                    Atualize seu endereço de email. Você precisará verificar o novo email.
                </CardDescription>
            </CardHeader>
            <form id="edit-email-form" action={formAction}>
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="newEmailAddress">Novo Endereço de Email</Label>
                        <Input
                            id="newEmailAddress"
                    ...
                    {state?.success && (
                        <div className="text-sm text-green-600">
                            Email de verificação enviado! Verifique sua caixa de entrada e clique no link para confirmar seu novo endereço de email.
                        </div>
                    )}
                    <Button type="submit" disabled={isPending}>
                        {isPending ? 'Enviando...' : 'Atualizar Email'}
                    </Button>
                </CardContent>
            </form>
        </Card>
